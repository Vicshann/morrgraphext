...
#include <Windows.h>
#include <objbase.h>
#include <oleauto.h>    // For 'VariantInit' and 'VariantClear' // Why is this suddenly became required?
#include "sapi.h"
#include "sapidef.h"
...
class CTalky
{
 ...
 public:
   ...
   DEFCALL ~CTalky();
//-----------------------------------
static inline void ResetVariant(VARIANT *pv,  VARTYPE type)  // VARIANT*
{
 ZeroObject(pv);
 VariantInit(pv);
 pv->vt = type;
...
//-----------------------------------
static inline void ReleaseVariant(VARIANT *pv)
{
 UINT Type =  pv->vt;
 VariantClear(pv);
...
//-----------------------------------
static inline void DuplicateVariant(VARIANT *pvdst, VARIANT *pvsrc)
{
 ReleaseVariant(pvdst);
 CopyObject(pvdst, pvsrc);
}
//-----------------------------------
template<class T> static void ZeroObject(T *Obj)
{
...
//-----------------------------------
template<class T> static void CopyObject(T *ObjDst, T *ObjSrc)
{
